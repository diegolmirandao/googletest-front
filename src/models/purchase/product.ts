import { IPurchaseProduct } from 'src/interfaces/purchase/product';
import { MProductDetailCost } from '../product/detailCost';
import { MMeasurementUnit } from '../product/measurementUnit';
import { MProductDetail } from '../product/detail';

export class MPurchaseProduct {
    public id: number;
    public purchaseId: number;
    public productDetailCostId: number;
    ...
    public cost: MProductDetailCost;

    constructor(product: IPurchaseProduct) {
        this.id = product.id;
        this.purchaseId = product.purchase_id;
        this.productDetailCostId = product.product_detail_cost_id;
        ...
        this.cost = new MProductDetailCost(product.cost);
    }
};