...
/**
 * Product Price Type Details Dialog
 * @param props component parameters
 * @returns Product Price Type Detail Dialog component
 */
const ProductPriceTypeDetailDialog = (props: IProps) => {
  // ** Props
              ...
              <Box>
                ...
                <Box sx={{ pt: 2, pb: 1 }}>
                  <Box sx={{ mb: 1 }}>
                    ...
                    <Typography variant='body1' sx={{ textAlign: 'right' }}>{currentProductPriceType?.name}</Typography>
                  </Box>
                </Box>
              </Box>
              {/*
              ...
              <TabContext value={tabValue}>
                ...
                <Box sx={{ mt: 3 }}>
                  <TabPanel sx={{ p: 0 }} value='parameters'>
                    {/*
                      START PRODUCT PRICE TYPE PARAMETES
                    */}
                    {/*
                      END PRODUCT PRICE TYPE PARAMETES
                    */}
                  </TabPanel>
                </Box>
              </TabContext>
...
export default ProductPriceTypeDetailDialog;
