 ...
 * @returns Business Detail Dialog component
 */
const BusinessDetailDialog = (props: IProps) => {
  // ** Props
              ...
              <Box>
                ...
                <Box sx={{ pt: 2, pb: 1 }}>
                  <Box sx={{ mb: 1 }}>
                    ...
                    <Typography variant='body1' sx={{ textAlign: 'right' }}>{currentBusiness?.name}</Typography>
                  </Box>
                </Box>
              </Box>
              {/*
              ...
              <TabContext value={tabValue}>
                ...
                <Box sx={{ mt: 3 }}>
                  <TabPanel sx={{ p: 0 }} value='parameters'>
                    {/*
                      START BUSINESS PARAMETES
                    */}
                    {/*
                      END BUSINESS PARAMETES
                    */}
                  </TabPanel>
                </Box>
              </TabContext>
