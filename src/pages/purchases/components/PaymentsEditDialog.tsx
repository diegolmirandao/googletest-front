...
interface IProps {
  open: boolean;
  selectedPayments?: IAddUpdatePurchasePayment[];
 ...
 */
const PurchasePaymentsEditDialog = (props: IProps) => {
  // ** Props
  ...
  const defaultValues: {payments: IAddUpdatePurchasePayment[]} = {
  ...
  return (
    ...
    >
      <DialogTitle sx={{ position: 'relative' }}>
        {currentPurchasePayment ? t('edit_payments') : t('add_payments')}
        <IconButton
          size='small'
          onClick={handleClose}
...
export default PurchasePaymentsEditDialog;
