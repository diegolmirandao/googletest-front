...
interface IProps {
  open: boolean;
  date?: Dayjs | null;
  selectedInstalments?: IUpdatePurchaseInstalment[];
  currency?: MCurrency;
  totalAmount: number;
  onSubmit: (formFields: IUpdatePurchaseInstalment[]) => void;
  onClose: () => void;
}
 ...
 */
const PurchaseInstalmentEditDialog = (props: IProps) => {
  // ** Props
  ...
  const getGeneratedInstalments = () => {
    let instalments: IUpdatePurchaseInstalment[] =  downPayment > 0 ? [{
      id: null,
      number: 0,
...
export default PurchaseInstalmentEditDialog;
